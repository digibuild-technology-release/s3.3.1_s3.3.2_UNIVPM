...
dataset_dir='C:/Users/utente/OneDrive - Università Politecnica delle Marche/Desktop/focchi_final/dataset_prep/dataset_test_singleroomNEW2.csv'
...
X_seqt=Xt.values.reshape(1, 168, 7)

####load the trained model for indoor T
loaded_model1=load_model('C:/Users/utente/OneDrive - Università Politecnica delle Marche/Desktop/s3.3.1_codes_v2/github/models/lstm_Tin_24_64_add_71024_room_norm_new2.h5') #replace the url with the correct one
...
X_seqrh=Xrh.values.reshape(1, 168, 7)
####load the trained model for indoor RH
loaded_model2=load_model('C:/Users/utente/OneDrive - Università Politecnica delle Marche/Desktop/s3.3.1_codes_v2/github/models/lstm_RH_24_64_add_810024_oneroom_norm2.h5')
...
####TSV NOW
tsv_model = pickle.load(open('C:/Users/utente/OneDrive - Università Politecnica delle Marche/Desktop/s3.3.1_codes_v2/github/models/random_forest.pkl', 'rb'))
X_now = pd.DataFrame()
