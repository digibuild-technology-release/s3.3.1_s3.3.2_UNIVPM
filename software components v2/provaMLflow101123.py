...
dataset=pd.read_csv(r'C:/Users/utente/OneDrive - Università Politecnica delle Marche/Desktop/focchi_pilot/data_focchi_by_univpm/input dataset/focchi_input_dataset_201123.csv', sep=',')
...
X=dataset.drop(['date','sPMV'], axis=1)
...
table_data = [
    ...
    ["NB", accuracy_nb, f1_score_nb, p_rf,recall_nb],
    ["KNN", accuracy_knn, f1_score_knn, p_rf,recall_knn],
    ["ADA", accuracy_ada, f1_score_ada, p_rf,recall_ada]
]
...
# plt.figure()
# plt.scatter(y_test,my_output_rf)
# plt.xlabel("y Test")
# plt.ylabel("y pred")
# plt.title("LSTM - comfort prediction")

# plt.figure(figsize = (20,5))
# plt.plot(y_test, label = 'reale')
# plt.plot(my_output_rf, label = 'predetto')
# plt.legend()
