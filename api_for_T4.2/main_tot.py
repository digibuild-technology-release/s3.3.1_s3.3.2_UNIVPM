...
async def calculate_comfort():  #environment: env_params, file: bytes=File(...)
    ...
    results = {}
    model_name= 's3://mlflow/3/2d4a91c9f5b04946ba5dcbbb29ab1f68/artifacts/BAG_univpm2' #'s3://mlflow/2/444207962697460482e1d6a2291aa340/artifacts/BAG_univpm'
...
async def predict_comfort(): #file: bytes=File(...)
    ...
    model_name2='s3://mlflow/2/48ecda08524e41cebb502c5d164135f6/artifacts/LSTM24_univpm_red'
    try:
       # Load the MLflow model
