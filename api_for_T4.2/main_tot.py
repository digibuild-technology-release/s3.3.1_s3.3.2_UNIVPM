...
async def calculate_comfort():  #environment: env_params, file: bytes=File(...)
    ...
    results = {}
    model_name= 's3://mlflow/72/50720372e429476880d4e71f6909a82d/artifacts/BAG_univpm2' #'s3://mlflow/2/444207962697460482e1d6a2291aa340/artifacts/BAG_univpm'
...
async def predict_comfort(): #file: bytes=File(...)
    ...
    model_name2='s3://mlflow/71/ba2b6e25487d442486a3e954b6dbe7a3/artifacts/LSTM24_univpm_reduced'
    try:
       # Load the MLflow model
